...
export default function SideBarNav() {
  return (
    <div className="sidebar bg-[#f7faf9] w-[200px] fixed top-[0] left-[0] h-screen z-[1000]">
      ...
      <div className="sidebar__wrapper flex flex-col justify-between pb-[20px] h-full pb-[60px] overflow-y-auto">
        <div className="sidebar__top mt-[40px]">
          ...
          >
            ...
            <div className="sider__link--text ">For you</div>
          </Link>
          <Link
            href=""
            className="sidebar_link--wrapper hover:bg-[#f0efef] flex items-center h-[56px] text-[#032b41] mb-[8px] cursor-pointer"
          >
            ...
            <div className="sider__link--text ">My Library</div>
          </Link>
          <Link
            href=""
            className="sidebar_link--wrapper hover:bg-[#f0efef] flex items-center h-[56px] text-[#032b41] mb-[8px] cursor-pointer"
          >
            ...
            <div className="sider__link--text ">Highlights</div>
          </Link>
          <Link
            href=""
            className="sidebar_link--wrapper hover:bg-[#f0efef] flex items-center h-[56px] text-[#032b41] mb-[8px] cursor-pointer"
