  ...
  return (
    <section id="numbers">
      <div className="w-full py-[40px]">
        <div className="row">
          <div className="section__title text-[24px] md:text-[32px] text-[#032b41] text-center mb-[32px] font-bold">Start growing with Summarist now</div>
          <div className="numbers__wrapper grid grid-cols-1 md:grid-cols-3 gap-[40px]">
            <div className="numbers bg-[#d7e9ff] flex flex-col items-center text-center p-[24px] pb-[40px] rounded-xl">
              ...
              <div className="numbers__title text-[32px] md:text-[40px] text-[#032b41] font-[600] mb-[16px]">3 Million</div>
            ...
            <div className="numbers bg-[#d7e9ff] flex flex-col items-center text-center p-[24px] pb-[40px] rounded-xl">
              ...
              <div className="numbers__title text-[32px] md:text text-[#032b41] font-[600] mb-[16px]">4.5 Stars</div>
            ...
            <div className="numbers bg-[#d7e9ff] flex flex-col items-center text-center p-[24px] pb-[40px] rounded-xl">
              ...
              <div className="numbers__title text-[32px] md:text text-[#032b41] font-[600] mb-[16px]">97%</div>
              <div className="numbers__sub--title text-[#394547] font-[300]">
